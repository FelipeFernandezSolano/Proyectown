        ...
        <div className="is-hero-inner">
          ...
          <aside className="is-hero-card reveal">
            <div className="is-card-top">
              ...
              <span className="is-chip"><Icon name="ship" size={13} /> Marítimo</span>
            </div>
            <h3>IMP-2026-041</h3>
            <div className="is-progress"><span style={{ width: "62%" }} /></div>
            <div className="is-card-rows">
              <div><span>Modalidad</span><b>Marítimo consolidado</b></div>
              <div><span>Etapa actual</span><b>En tránsito</b></div>
              <div><span>Entrega estimada</span><b>40 - 55 días</b></div>
            </div>
            <div className="is-card-track">
              <i className="on" /><i className="on" /><i className="on" /><i /><i />
              <span>Proveedor</span><span>Bodega</span><span>Tránsito</span><span>Aduana</span><span>Entrega</span>
            </div>
          </aside>
        </div>
      </section>
