...
public class ClienteDemoInitializer implements CommandLineRunner {
    ...
    private void prepararCompatibilidadBaseDatos() {
        ...
        ejecutarSqlSeguro("ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS telefono VARCHAR(30) NULL");
        ejecutarSqlSeguro("ALTER TABLE usuarios ADD COLUMN IF NOT EXISTS reset_token VARCHAR(100) NULL");
